...
export default {
  ...
  methods: {
    async queryFDM(fatDataModelIndex, fatDataModelEntity) {
      this.$router.push({ path: '/datamodel/query', query: { dmType: 'FatModel', dmId: fatDataModelEntity._id }})
    },
    async editFDM(fatDataModelIndex, fatDataModelEntity) {
      this.$router.push({ path: '/datamodel/edit', query: { dmType: 'FatModel', dmId: fatDataModelEntity._id }})
    },
